  ...
  return (
    <div className="fixed inset-0 z-[200] bg-[#040f1e] flex flex-col items-center justify-center p-5 overflow-y-auto">
      ...
      <div className="relative w-full max-w-sm py-8">
        ...
        {/* Card */}
        <div className="bg-white/4 border border-white/8 rounded-3xl p-6 shadow-2xl backdrop-blur-sm">
          {/* Title */}
          <div className="mb-5">
          ...
          {/* Email / Phone toggle */}
          <div className="flex items-center bg-white/5 rounded-xl p-1 mb-4 gap-1">
            <button
              type="button"
              ...
              className={cn(
                ...
                method === 'email'
                  ? 'bg-[#00B4D8] text-white shadow-md shadow-[#00B4D8]/25'
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder={method === 'email' ? 'your@email.com' : '+971 5X XXX XXXX'}
                className={cn(inputClass, 'pl-10')}
